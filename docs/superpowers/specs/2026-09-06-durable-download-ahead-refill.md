...
Local ADRs and the audit are not pushed. This public contract includes their relevant obligations and can be implemented through the linked dependency-aware tickets without an unpublished source link.
