...
These dated records describe the named candidate, environment, method, observed result, and limits at the time of testing. They do not verify a later commit. For current work, choose evidence with the [testing guide](../agents/testing.md), then use the [sandbox runbook](../sandbox.md) or [feature recipes](../testing-recipes.md) when relevant.
