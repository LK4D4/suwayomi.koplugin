...
describe("suwayomi/ui/browse", function()
    ...
    it("shows source filter editor rows and title actions", function()
        ...
        assert.are.equal("ctx:source filter sort summary:Name - Ascending", shown_dialog.item_table[6].mandatory)
        ...
        shown_dialog.buttons[2][1].callback()
        assert.are.equal("ctx:source filter sort summary:Updated - Ascending", editor.item_table[6].mandatory)
        editor.item_table[6].callback()
        shown_dialog.buttons[4][1].callback()
        assert.are.equal("ctx:source filter sort summary:Updated - Descending", editor.item_table[6].mandatory)
    ...
    it("refreshes source filter sort rows after modal edits", function()
        ...
        assert.are.equal("ctx:source filter sort summary:Updated - Ascending", editor.item_table[1].mandatory)
        assert.are.same({ { select_number = nil, no_recalculate_dimen = true } }, refreshes)
    end)
